...
class FedMD():
    def __init__(self, parties, public_dataset,
        ...
        self.combined = Model(z, validity_output, name='combined')
    ...
    def collaborative_training(self):
        ...
        while True:
            ...
            for index, d in enumerate(self.collaborative_parties):
                ...
                d["model_logits"].fit(gen_imgs, [logits, fake],
                                      batch_size=self.logits_matching_batchsize,
                                      epochs=self.N_logits_matching_round,
                                      shuffle=True, verbose=True)

                d["model_logits"].fit(alignment_data[index]["X"], [logits_true, valid],
                                      batch_size=self.logits_matching_batchsize,
                                      epochs=self.N_logits_matching_round,
                                      shuffle=True, verbose=True)
